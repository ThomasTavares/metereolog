...
WindDirectionInfo Anemoscope::read() {
    ...
    else if (info.voltage >= 1.6) info.angle = 90; // E
    else if (info.voltage >= 1.3) info.angle = 135; // SE
    else if (info.voltage >= 1.1) info.angle = 180; // S
    else if (info.voltage >= 0.95) info.angle = 225; // SW
    else if (info.voltage >= 0.85) info.angle = 270; // W
    else if (info.voltage >= 0.6) info.angle = 315; // NW
    else info.angle = 0; // N
